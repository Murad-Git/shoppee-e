...
export default function InfoBlock() {
  return (
    <div className="h-full container">
      <div className="h-full grid grid-cols-1  justify-items-center w-[60%] mx-auto">
        <div className="h-full w-full flex items-center justify-start mb-8">
          <section className="flex justify-start items-center">
            <FontAwesomeIcon
              className="mr-4 text-4xl text-accent-color"
              icon={faTruck}
            />
            <div>
